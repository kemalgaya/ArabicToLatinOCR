...
class Bizroke:
    def add_rule_01(self, x):
        ...
        return re.sub(
            re.compile(
                r"([bcçdfghjklĺmnpqrŕsştvwxz])([fjlĺmnrŕsşvwxyz])([i])([fjlĺmnrŕsşvwxyz])([^aeêiîouûy])"
            ),
            r"\1\2\4\5",
            x,
        )
    ...
    def add_rule_02(self, x):
        ...
        return re.sub(
            re.compile(
                r"([aeêiîouû])([bcçdfghjklĺmnpqrŕsştvwxz])([bcçdfghjklĺmnpqrŕsştvwxz])([i])([bcçdfghjklĺmnpqrŕsştvwxz])"
            ),
            r"\1\2\3\5",
            x,
        )
    ...
    def add_rule_03(self, x):
        ...
        return re.sub(
            re.compile(
                r"([fjlĺrŕsşwyz])([i])([fjlĺmnrŕsşvwxyz])([bcçdfghjklĺmnpqrŕsştvwxz])"
            ),
            r"\1\3\4",
            x,
        )
    ...
    def add_rule_04(self, x):
        ...
        self.x = x
        return re.sub(
            re.compile(r"([bcçdghĥkmnpqtvx])([i])([fjlĺmnrŕsşvwxyz])($|[^aeêiîouû])"),
            r"\1\3\4",
            x,
        )
    ...
    def add_rule_05(self, x):
        ...
        return re.sub(
            re.compile(
                r"(^|[^aeêiîouy])([bcçdfghjklĺmnpqrŕsştvwxz])([i])([bcçdfghjklĺmnpqrŕsştvwxz])($|[^aeêiîouû])"
            ),
            r"\1\2\4\5",
            x,
        )
    ...
    def add_rule_06(self, x):
        ...
        self.x = x
        return re.sub(
            re.compile(r"(^|[^a-zçşêîûĺŕ\'])([bcçdfghjklĺmnpqrŕsştvwxz])([i])(\b)"),
            r"\1\2\4",
            x,
        )
    def add_rule_07(self, x):
        """
            e.g. kçe --> kiçe
            """
        self.x = x
    ...
    def re_rule_01(self, x):
        ...
        return re.sub(
            re.compile(
                r"([aeou]?)([brcmxkwtdzhpgĺş])(i)([nlsrmzĺrş])([rcdmtbsŕnkg][lnw]?)([aêîueo]?)"
            ),
            r"\1\2\4\3\5\6",
            x,
        )
    ...
    def rm_rule_04(self, x):
        """
            e.g. neşmîlm --> neşmîlim
            """
        self.x = x
        return re.sub(
            re.compile(r"([n])([e])(ş)([m])([î])([l])([m])"),
            r"\1\2\3\4\5\6i\7",
            x,
        )
    ...
    def extra_add_rule_01(self, x):
        """
            ...
            """
        self.x = x
        return re.sub(re.compile(r"([nd])([i])([r][aeêiîouû])"), r"\1\3", x)
    ...
    def extra_add_rule_02(self, x):
        """
            ...
            """
        self.x = x
        return re.sub(re.compile(r"(t)([i])(r)(î)(n)"), r"\1\3\4\5", x)
