...
from Classes import bizrokeRules2
from Classes import bizrokeRules
from Classes import punctuation
from Classes import vowelIssues
...
class Hemwar:
    ...
    def la_to_ar(self, textContent):
        ...
        mapping = {
            ...
            # "ئ": "",  # It changes U+0626 to NONE
            # "ٸ": "",  # It changes U+0678 to NONE
            "a":"ا",  # It changes U+0627 to U+0061
            "b": "ب",  # It changes U+0628 to U+0062
            "p": "پ",  # It changes U+067E to U+0070
            "t": "ت",  # It changes U+062A to U+0074
            "c": "ج",  # It changes U+062C to U+0063
            "ç": "چ",  # It changes U+0686 to U+00E7
            "ĥ": "ح",  # It changes U+062D to U+0125
            "x": "خ",  # It changes U+062E to U+0078
            "d": "د",  # It changes U+062F to U+0064
            "r": "ر",  # It changes U+0631 to U+0072
            # 'ڕ': 'r\u0302', # It changes U+0695 to ( U+0072 + U+0302 = r̂ )
            "ŕ": "ڕ",  # It changes U+0695 to U+0155 --> Temporarily selected till the formal one will be dedicated.
            "z": "ز",  # It changes U+0632 to U+007A
            "j": "ژ",  # It changes U+0698 to U+006A
            "s": "س",  # It changes U+0633 to U+0073
            "ş": "ش",  # It changes U+0634 to U+015F
            # "ع": "'",  # It changes U+0639 to U+0027 --> Temporarily selected till the formal one will be dedicated.
            # 'غ': 'x\u0302', # It changes U+063A to ( U+0078 + U+0302 = x̂ )
            "ẍ": "غ",  # It changes U+063A to U+1E8D --> Temporarily selected till the formal one will be dedicated.
            "f": "ف",  # It changes U+0641 to U+0066
            "v": "ڤ",  # It changes U+06A4 to U+0076
            "q": "ق",  # It changes U+0642 to U+0071
            "k": "ک",  # It changes U+06A9 to U+006B
            "k": "ك",  # It changes U+0643 to U+006B
            "k": "ڪ",  # It changes U+06AA to U+006B
            "g": "گ",  # It changes U+06AF to U+0067
            "l": "ل",  # It changes U+0644 to U+006C
            # 'ڵ': 'l\u0302', # It changes U+06B5 to ( U+006C + U+0302 = l̂ )
            "ĺ": "ڵ",  # It changes U+06B5 to U+013A --> Temporarily selected till the formal one will be dedicated.
            "m": "م",  # It changes U+0645 to U+006D
            "n": "ن",  # It changes U+0646 to U+006E
            # "وو": "û",  # It changes (U+0648 + U+0648) to U+00FB
            # "و": "w",  # It changes U+0648 to U+0077
            "o": "ۆ",  # It changes U+06C6 to U+006F
            "e": "\u200cه",  # It changes ( U+200C + U+0647 ) to 0065
            "e": "ه\u200c",  # It changes ( U+0647 + U+200C ) to 0065
            "h": "ه",  # It changes U+0647 to U+0068
            "h": "ھ",  # It changes U+06BE to U+0068
            "e": "ە",  # It changes U+06D5 to U+0065
            "îy": "یی",  # It changes ( U+06cc + U+06cc ) to ( U+00ee + U+0079 )
            # "ی": "y",  # It changes U+06CC to U+0079
            # "ي": "y",  # It changes U+064A to U+0079
            # "ى": "y",  # It changes U+0649 to U+0079
            "ê": "ێ",  # It changes U+06CE to U+00EA
            ",": "،",  # It changes U+060C to U+002C
            ";": "؛",  # It changes U+061B to U+003B
            "‌": "",  # removing U+200C to NONE(Zero Width Non-Joiner (ZWNJ)) in Latin text (NOTE: It is not space character (U+0020))
            #"ـ": "",  # (U+0640) TO BE REMOVED in Latin-based Kurdish
            "?": "؟",  # It changes U+061F to U+003F
            "0": "۰",  # It changes U+06F0 to U+0030
            "1": "۱",  # It changes U+06F1 to U+0031
            "2": "۲",  # It changes U+06F2 to U+0032
            "3": "۳",  # It changes U+06F3 to U+0033
            "4": "۴",  # It changes U+06F4 to U+0034
            "5": "۵",  # It changes U+06F5 to U+0035
            "6": "۶",  # It changes U+06F6 to U+0036
            "7": "۷",  # It changes U+06F7 to U+0037
            "8": "۸",  # It changes U+06F8 to U+0038
            "9": "۹",  # It changes U+06F9 to U+0039
            "0": "٠",  # It changes U+0660 to U+0030
            "1": "١",  # It changes U+0661 to U+0031
            "2": "٢",  # It changes U+0662 to U+0032
            "3": "٣",  # It changes U+0663 to U+0033
            "4": "٤",  # It changes U+0664 to U+0034
            "5": "٥",  # It changes U+0665 to U+0035
            "6": "٦",  # It changes U+0666 to U+0036
            "7": "٧",  # It changes U+0667 to U+0037
            "8": "٨",  # It changes U+0668 to U+0038
            "9": "٩",  # It changes U+0669 to U+0039
            "(": "(",  # It changes U+0028 to U+0028
            ")": ")",  # It changes U+0029 to U+0029
            "[": "[",  # It changes U+005B to U+005B
            "]": "]",  # It changes U+005D to U+005D
